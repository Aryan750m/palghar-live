<?php
// errors/404.php — Custom 404 Not Found page
...
<head>
    ...
    <title>404 — Page Not Found | Palghar LIVE</title>
    ...
    <style>
        ...
        .error-code { font-size: clamp(6rem, 15vw, 10rem); font-weight: 900; background: linear-gradient(135deg, var(--primary), var(--secondary)); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; line-height: 1; }
...
<body>
    <div class="error-page">
        ...
        <p class="error-desc">The news story or page you are looking for has been moved, renamed, or may no longer exist on Palghar LIVE.</p>
        <div class="error-actions">
            <a href="../index.php" class="btn-live"><i class="fas fa-home"></i> Go to Homepage</a>
            <a href="javascript:history.back()" class="read-more-btn"><i class="fas fa-arrow-left"></i> Go Back</a>
        </div>
        <p style="margin-top: 40px; color: var(--text-muted); font-size: 0.8rem;">
            <a href="../index.php" style="color: var(--primary);">Palghar LIVE</a> — The Strong Voice of the Common People
        </p>
    </div>
</body>
</html>
